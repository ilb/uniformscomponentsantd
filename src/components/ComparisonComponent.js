/* eslint-disable no-unused-vars, no-undefined, n/no-missing-import, no-undef, no-shadow -- Отключаем eslint no-unused-vars, no-undefined, n/no-missing-import, no-undef */
import { Form } from "antd";
import { useEffect, useState } from "react";
import { connectField } from "uniforms";

import { genDynHTML, getCursorPosition } from "../libs/dynamicInput";
 ...
 * @param {string} props.valueToCompare
 * @param {Function} props.onChange
 * @param {string} props.caseMode
 * @returns {JSX.Element}
 */
...
/* eslint-enable no-unused-vars, no-undefined, n/no-missing-import, no-undef, no-shadow -- Возвращаем eslint no-unused-vars, no-undefined, n/no-missing-import, no-undef, no-shadow */
